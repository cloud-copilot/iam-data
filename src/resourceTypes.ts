 ...
 */
export function resourceTypesForService(serviceKey: string): string[] {
 ...
 */
export function resourceTypeExists(serviceKey: string, resourceTypeKey: string): boolean {
  const data = readResourceTypes<Record<string, ResourceType>>(serviceKey);
 ...
 */
export function getResourceTypeDetails(serviceKey: string, resourceTypeKey: string): ResourceType {
  const data = readResourceTypes<Record<string, ResourceType>>(serviceKey);
